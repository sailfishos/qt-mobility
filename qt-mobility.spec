...
Patch0:     revert_QTMOBILITY-614_bmc13087.patch
Patch1:     no_rpath.patch
Patch2:     enable_camerabin_with_meego_target.patch
Patch3:     GL_CLAMP_TO_EDGE_for_video_texture.patch
Patch4:     opengl-es2-shader-enable.patch
%ifarch %{ix86}
Patch5:     revert-m_pools-in-qvideosurfacegstsink.patch
%endif
%ifarch %{ix86}
Patch6:     libva-codec-enable.patch
%endif
%ifarch %{ix86}
Patch7:     camera_preview_workaround.patch
%endif
%ifarch %{ix86}
Patch8:     Moorestown_Camera_Support.patch
%endif
%ifarch %{arm}
...
Patch12:     versit_reverse_geolocation_lat_lon_order.patch
Patch13:     versit_add_meego_vcard_entries.patch
Patch14:     contacts_fix_schema_definitions.patch
...
%patch4 -p1
%ifarch %{ix86}
# revert-m_pools-in-qvideosurfacegstsink.patch
%patch5 -p1
%endif
%ifarch %{ix86}
...
# >> install pre
%qmake_install
# Install MeeGo Handset Camera application files
#cp -a examples/declarative-camera/qml_camera %{buildroot}%{_bindir}/meegocamera
# << install pre
