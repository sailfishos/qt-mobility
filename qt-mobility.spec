...
Source0:    %{name}-v1.2.0-1962-g8c17475.tar.bz2
Source1:    %{name}-rpmlintrc
Source100:  qt-mobility.yaml
Patch0:     0001-Enable-gstreamer-camerabin-backend.patch
%ifarch %{arm}
Patch1:     0002-Use-xvoverlay-rendering-instead-of-gles2-painting.patch
%endif
Patch2:     0003-QtContacts-Add-missing-entries-to-schema-definition.patch
Patch3:     0004-Sync-macros-to-Qt-4.8.patch
Patch4:     0005-Revert-compile-on-MeeGo.patch
Patch5:     0006-Add-new-features-to-camera-API-for-camera-app-usage.patch
Patch6:     0007-Use-xvideo-in-QGstreamerPlayerService.patch
Patch7:     0008-Improve-QSystemDeviceInfo-uniqueDeviceID-value.patch
Patch8:     0009-fix-for-MER-625.patch
Patch9:     0010-Fix-query-syntax-for-PhotoAlbum-children.patch
Patch10:     0011-Fix-QDeclarativeHapticsEffect-setIntensity.patch
Patch11:     0012-Enable-resource-policy-integration-for-media-player-.patch
Patch12:     0013-Enable-resource-policy-integration-for-camerabin-plu.patch
Patch13:     0014-Add-libresourceqt1-to-PKGCONFIG-when-building-for-Me.patch
Patch14:     0015-Allow-playback-if-resource-manager-is-not-available.patch
...
-exec perl -pi -e "s, -L%{_builddir}/%{name}\E/?\S+,,g" {} \;
...
%{_includedir}/QtLocation/QLocationNetworkAccessManagerFactory
